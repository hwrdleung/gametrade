...
var GamesDataService = /** @class */ (function () {
    function GamesDataService(http) {
        ...
        this.IGDB_API_KEY = '09f049c49c43481b21812a91f6559298';
        this.IGDB_API_KEYWORD_SEARCH_ENDPOINT = 'https://api-endpoint.igdb.com/games/?search=';
        this.IDGB_API_GAME_ID_SEARCH_ENDPOINT = 'https://api-endpoint.igdb.com/games/';
        this.serverEndpoint = 'https://gametrader.herokuapp.com';
        this.getCoverEndpoint = this.serverEndpoint + '/user/get_cover_url';
        this.searchResults = [];
    }
    GamesDataService.prototype.test = function () {
    ...
    GamesDataService.prototype.searchGame = function (searchFormValue) {
        ...
        this.http.get(this.IGDB_API_KEYWORD_SEARCH_ENDPOINT + query, httpOptions).subscribe(function (res) {
            ...
            for (var game in searchResults) {
                ...
                _this.http.get(_this.IDGB_API_GAME_ID_SEARCH_ENDPOINT + gameId, httpOptions).subscribe(function (res) {
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_4__trade_service__["a" /* TradeService */], __WEBPACK_IMPORTED_MODULE_3__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]])
    ], ProfileComponent);
